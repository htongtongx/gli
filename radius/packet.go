...
const (
	...
	CodeIIPActiveRequest   Code = 20
	CodeIIPActiveResponse  Code = 21
...
func (p *Packet) IsAuthentic(request *Packet) bool {
	...
	case CodeAccountingResponse, CodeIIPActiveResponse:
		wire, err := p.Encode()
		if err != nil {
			return false
		}
...
func (p *Packet) Encode() ([]byte, error) {
	...
	case CodeAccessAccept, CodeAccessReject, CodeAccountingRequest, CodeAccountingResponse, CodeAccessChallenge, CodeIIPActiveRequest, CodeIIPActiveResponse:
		hash := md5.New()
